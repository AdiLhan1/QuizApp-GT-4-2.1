...
### Project themes: Basic architecture(MVVM & Repository), Retrofit, Room, Recycler.
...
#### P.S. Можете само3стоятельно добавлять доп. слои, реализовать Presentation слой с помощью MVP, MVVM и использовать тот стэк технологий которым владеете на данный момент
